...
class TrackSelectionInvestigationTest {
    ...
    fun testBuildStreamInfoDataWithActiveVideoFormat() {
        ...
        every { controller.currentInternalPlayerEngine } returns dev.khayin.app.data.local.InternalPlayerEngine.EXOPLAYER
    ...
    fun testDolbyVisionExtractorsFactoryFormatRewriting() {
        ...
        val factory = dev.khayin.app.core.player.DolbyVisionExtractorsFactory(
            delegate = delegateFactory,
            config = dev.khayin.app.core.player.DolbyVisionConversionConfig(active = false),
            stripDvRpu = true
        )
