package dev.khayin.app.core.plugin.cloudstream
...
import dev.khayin.app.core.plugin.TestDiagnostics
...
class ExternalExtensionLoader @Inject constructor(
    ...
    suspend fun downloadExtension(scraperId: String, downloadUrl: String): File? = withContext(Dispatchers.IO) {
        dev.khayin.app.core.runtime.PluginRuntimeHooks.ensureCloudstreamInitialized()
        try {
