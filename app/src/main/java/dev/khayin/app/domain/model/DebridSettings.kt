...
data class DebridSettings(
    ...
    val resolverServices: List<dev.khayin.app.core.debrid.DebridServiceCredential>
        get() = DebridProviders.configuredResolverServices(this)

    val activeResolverCredential: dev.khayin.app.core.debrid.DebridServiceCredential?
    ...
    val hasCloudLibraryProvider: Boolean
        get() = DebridProviders.configuredServices(this)
            .any { credential -> credential.provider.supports(dev.khayin.app.core.debrid.DebridProviderCapability.CloudLibrary) }
