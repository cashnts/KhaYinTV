...
class TorboxDirectDebridResolver @Inject constructor(
    ...
    private fun Response<dev.khayin.app.data.remote.dto.TorboxEnvelopeDto<TorboxCreateTorrentDataDto>>.extractTorrentId(): Int? {
    ...
    private fun Response<dev.khayin.app.data.remote.dto.TorboxEnvelopeDto<TorboxCreateTorrentDataDto>>.toFailureForCreate(): DirectDebridResolveResult {
        return when (code()) {
