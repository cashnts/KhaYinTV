package dev.khayin.app.ui.navigation
...
import dev.khayin.app.ui.screens.CatalogSeeAllScreen
import dev.khayin.app.ui.screens.ExperienceModeSelectionScreen
import dev.khayin.app.ui.screens.LayoutSelectionScreen
import dev.khayin.app.ui.screens.detail.MetaDetailsScreen
import dev.khayin.app.ui.screens.home.HomeScreen
import dev.khayin.app.ui.screens.addon.AddonManagerScreen
import dev.khayin.app.ui.screens.addon.CatalogOrderScreen
import dev.khayin.app.ui.screens.library.LibraryScreen
import dev.khayin.app.ui.screens.player.PlayerExitReason
import dev.khayin.app.ui.screens.player.PlayerScreen
import dev.khayin.app.ui.screens.plugin.PluginScreen
import dev.khayin.app.ui.screens.search.DiscoverScreen
import dev.khayin.app.ui.screens.search.SearchScreen
import dev.khayin.app.ui.screens.settings.AboutScreen
import dev.khayin.app.ui.screens.settings.LayoutSettingsScreen
import dev.khayin.app.ui.screens.settings.LicensesAttributionsScreen
import dev.khayin.app.ui.screens.settings.PlaybackSettingsScreen
import dev.khayin.app.ui.screens.settings.SettingsScreen
import dev.khayin.app.ui.screens.settings.SupportersContributorsScreen
import dev.khayin.app.ui.screens.settings.ThemeSettingsScreen
import dev.khayin.app.ui.screens.settings.TrackingSettingsScreen
import dev.khayin.app.ui.screens.settings.TmdbSettingsScreen
import dev.khayin.app.ui.screens.stream.StreamScreen
import dev.khayin.app.ui.screens.home.ContinueWatchingItem
import dev.khayin.app.ui.screens.account.AuthQrSignInScreen
import dev.khayin.app.ui.screens.cast.CastDetailScreen
import dev.khayin.app.ui.screens.profile.ProfileSelectionMode
import dev.khayin.app.ui.screens.profile.ProfileSelectionScreen
import dev.khayin.app.ui.screens.tmdb.TmdbEntityBrowseScreen
import dev.khayin.app.ui.screens.home.HeroBackdropState
...
fun NuvioNavHost(
    ...
    NavHost(
        ...
        composable(Screen.Search.route) { backStackEntry ->
            val searchViewModel: dev.khayin.app.ui.screens.search.SearchViewModel =
        ...
        composable(Screen.Collections.route) {
            dev.khayin.app.ui.screens.collection.CollectionManagementScreen(
        ...
        composable(
            ...
            dev.khayin.app.ui.screens.collection.CollectionEditorScreen(
                onBack = { navController.popBackStack() }
            )
        }
        ...
        composable(
            ...
            dev.khayin.app.ui.screens.collection.FolderDetailScreen(
                onNavigateToDetail = { itemId, itemType, addonBaseUrl ->
                    val heroBackdrop = HeroBackdropState.consumeAndClear()
        ...
        composable(
            ...
            val searchViewModel: dev.khayin.app.ui.screens.search.SearchViewModel? =
                if (searchBackStackEntry != null) {
                    androidx.hilt.navigation.compose.hiltViewModel<dev.khayin.app.ui.screens.search.SearchViewModel>(searchBackStackEntry)
                } else null
            ...
            val homeViewModel: dev.khayin.app.ui.screens.home.HomeViewModel =
