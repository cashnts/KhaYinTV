...
fun AddonManagerScreen(
    ...
    val manageFromPhoneSubtitle = if (webConfigMode == dev.khayin.app.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
    ...
    val qrInstruction = if (webConfigMode == dev.khayin.app.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
