...
import dev.khayin.app.ui.util.dpadRepeatThrottle
import dev.khayin.app.ui.util.dpadVerticalFastScroll
import dev.khayin.app.ui.util.localizedContentType
...
import dev.khayin.app.ui.components.CatalogRowSection
import dev.khayin.app.ui.components.ContentCard
import dev.khayin.app.ui.components.LoadingIndicator
import dev.khayin.app.R
import androidx.compose.ui.res.stringResource
import dev.khayin.app.ui.components.PosterCardDefaults
import dev.khayin.app.ui.components.PosterCardStyle
import dev.khayin.app.ui.components.LocalCardDepthStyle
import dev.khayin.app.ui.components.nuvioCardDepth
import dev.khayin.app.domain.model.CardDepthSurface
import dev.khayin.app.ui.screens.home.ClassicHomeContent
import dev.khayin.app.ui.screens.home.ContinueWatchingItem
import dev.khayin.app.ui.screens.home.GridHomeContent
import dev.khayin.app.ui.screens.home.HeroBackdropState
import dev.khayin.app.ui.screens.home.HomeScreenFocusState
import dev.khayin.app.ui.screens.home.key
import dev.khayin.app.domain.model.MetaPreview
import dev.khayin.app.ui.screens.home.ModernHomeContent
...
fun FolderDetailScreen(
    ...
    val isItemWatched: (MetaPreview) -> Boolean = remember(uiState.movieWatchedStatus) {
        { item -> uiState.movieWatchedStatus[dev.khayin.app.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
    ...
    dev.khayin.app.ui.components.posteroptions.PosterOptionsHost(
...
@Composable
private fun FolderHeader(folder: dev.khayin.app.domain.model.CollectionFolder) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
        ...
        if (!folder.coverImageUrl.isNullOrBlank()) {
            ...
            when (folder.tileShape) {
                dev.khayin.app.domain.model.PosterShape.POSTER -> { iconWidth = NuvioTheme.spacing.xxl; iconHeight = NuvioTheme.spacing.xxxl }
                dev.khayin.app.domain.model.PosterShape.LANDSCAPE -> { iconWidth = 64.dp; iconHeight = 36.dp }
                dev.khayin.app.domain.model.PosterShape.SQUARE -> { iconWidth = NuvioTheme.spacing.xxxl; iconHeight = NuvioTheme.spacing.xxxl }
            }
            AsyncImage(
...
private fun TabbedGridContent(
    ...
    folder: dev.khayin.app.domain.model.CollectionFolder,
...
private fun FollowLayoutContent(
    ...
    val isItemWatched: (MetaPreview) -> Boolean = remember(homeState.movieWatchedStatus) {
        { item -> homeState.movieWatchedStatus[dev.khayin.app.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
    val loadMoreLabel = stringResource(R.string.action_load_more)
