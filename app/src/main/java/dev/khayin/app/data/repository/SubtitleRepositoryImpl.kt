...
import dev.khayin.app.data.local.AddonPreferences
...
class SubtitleRepositoryImpl @Inject constructor(
    ...
    private fun supportsType(addon: Addon, resource: dev.khayin.app.domain.model.AddonResource, type: String, id: String): Boolean {
