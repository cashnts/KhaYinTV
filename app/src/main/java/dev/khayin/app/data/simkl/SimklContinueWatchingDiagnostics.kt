...
import dev.khayin.app.core.tracking.TrackingDiagnosticIdentity
...
private fun dev.khayin.app.domain.model.WatchedItem?.toDiagnosticEpisode(): SimklDiagnosticEpisode? =
