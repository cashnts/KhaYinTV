...
import dev.khayin.app.core.debrid.DebridProviders
import dev.khayin.app.core.debrid.DebridStreamFormatterDefaults
import dev.khayin.app.core.profile.ProfileManager
import dev.khayin.app.domain.model.DebridSettings
import dev.khayin.app.domain.model.DebridStreamCodecFilter
import dev.khayin.app.domain.model.DebridStreamEncode
import dev.khayin.app.domain.model.DebridStreamFeatureFilter
import dev.khayin.app.domain.model.DebridStreamMinimumQuality
import dev.khayin.app.domain.model.DebridStreamPreferences
import dev.khayin.app.domain.model.DebridStreamResolution
import dev.khayin.app.domain.model.DebridStreamSortCriterion
import dev.khayin.app.domain.model.DebridStreamSortDirection
import dev.khayin.app.domain.model.DebridStreamSortKey
import dev.khayin.app.domain.model.DebridStreamSortMode
import dev.khayin.app.domain.model.DebridStreamVisualTag
import dev.khayin.app.domain.model.normalizeDebridInstantPlaybackPreparationLimit
import dev.khayin.app.domain.model.normalizeDebridStreamMaxResults
...
class DebridSettingsDataStore @Inject constructor(
    ...
    private fun DebridStreamPreferences.normalized(): DebridStreamPreferences {
        ...
        val preferredQualitiesValue: List<dev.khayin.app.domain.model.DebridStreamQuality>? = preferredQualities
        val requiredQualitiesValue: List<dev.khayin.app.domain.model.DebridStreamQuality>? = requiredQualities
        val excludedQualitiesValue: List<dev.khayin.app.domain.model.DebridStreamQuality>? = excludedQualities
        ...
        val preferredAudioTagsValue: List<dev.khayin.app.domain.model.DebridStreamAudioTag>? = preferredAudioTags
        val requiredAudioTagsValue: List<dev.khayin.app.domain.model.DebridStreamAudioTag>? = requiredAudioTags
        val excludedAudioTagsValue: List<dev.khayin.app.domain.model.DebridStreamAudioTag>? = excludedAudioTags
        val preferredAudioChannelsValue: List<dev.khayin.app.domain.model.DebridStreamAudioChannel>? = preferredAudioChannels
        val requiredAudioChannelsValue: List<dev.khayin.app.domain.model.DebridStreamAudioChannel>? = requiredAudioChannels
        val excludedAudioChannelsValue: List<dev.khayin.app.domain.model.DebridStreamAudioChannel>? = excludedAudioChannels
        ...
        val preferredLanguagesValue: List<dev.khayin.app.domain.model.DebridStreamLanguage>? = preferredLanguages
        val requiredLanguagesValue: List<dev.khayin.app.domain.model.DebridStreamLanguage>? = requiredLanguages
        val excludedLanguagesValue: List<dev.khayin.app.domain.model.DebridStreamLanguage>? = excludedLanguages
        ...
        return copy(
            ...
            preferredQualities = preferredQualitiesValue?.ifEmpty { dev.khayin.app.domain.model.DebridStreamQuality.defaultOrder } ?: dev.khayin.app.domain.model.DebridStreamQuality.defaultOrder,
            ...
            preferredAudioTags = preferredAudioTagsValue?.ifEmpty { dev.khayin.app.domain.model.DebridStreamAudioTag.defaultOrder } ?: dev.khayin.app.domain.model.DebridStreamAudioTag.defaultOrder,
            requiredAudioTags = requiredAudioTagsValue.orEmpty(),
            excludedAudioTags = excludedAudioTagsValue.orEmpty(),
            preferredAudioChannels = preferredAudioChannelsValue?.ifEmpty { dev.khayin.app.domain.model.DebridStreamAudioChannel.defaultOrder } ?: dev.khayin.app.domain.model.DebridStreamAudioChannel.defaultOrder,
