...
import dev.khayin.app.data.remote.dto.mdblist.MDBListRatingRequestDto
import dev.khayin.app.domain.model.MDBListRatings
import dev.khayin.app.domain.model.MDBListRatingsResult
        ...
        val imdbId = resolveImdbId(
            meta = Meta(
                ...
                type = when (normalizeMediaType(itemType)) {
                    "show" -> dev.khayin.app.domain.model.ContentType.SERIES
                    else -> dev.khayin.app.domain.model.ContentType.MOVIE
                },
                name = itemId,
                poster = null,
