...
import dev.khayin.app.core.trakt.traktBestLandscapeUrl
    ...
    suspend fun getRelated(
        ...
        val items = when (target.type) {
            TraktRelatedType.MOVIE -> {
                ...
                } ?: throw IllegalStateException(appContext.getString(dev.khayin.app.R.string.trakt_related_error_request_failed))
