...
internal fun PersistedTrackPreference.toTrackPreference(): dev.khayin.app.ui.screens.player.PlayerRuntimeController.TrackPreference? {
    val audio = if (audioLanguage != null || audioName != null || audioTrackId != null) {
        dev.khayin.app.ui.screens.player.PlayerRuntimeController.RememberedTrackSelection(
    ...
    val subtitle = when (subtitleType) {
        "INTERNAL" -> dev.khayin.app.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Internal(
            track = dev.khayin.app.ui.screens.player.PlayerRuntimeController.RememberedTrackSelection(
        ...
        "ADDON" -> dev.khayin.app.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Addon(
            id = addonSubtitleId ?: "",
            url = addonSubtitleUrl ?: "",
            language = subtitleLanguage ?: "",
            addonName = addonSubtitleAddonName ?: ""
        )
        "DISABLED" -> dev.khayin.app.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Disabled
        else -> null
    }

    if (audio == null && subtitle == null) return null
    return dev.khayin.app.ui.screens.player.PlayerRuntimeController.TrackPreference(
        audio = audio,
        subtitle = subtitle
    )
}
